...
% function generate_dataset(full_runways_data,...
...
% Input :
% full_runways_data (N 1-d cell array of runways data struct) : runways data associated with each sub-dataset
...
[full_labels_data, ~, dataset_size] = generate_heterogenous_predataset(full_runways_data,...
                                                        full_camera_locations,...
                                                        full_calibration_data,...
                                                        preDatasetFolder,...
