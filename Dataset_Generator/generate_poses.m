...
% function [poses_data, poses_count] = generate_poses(runways_data, coord_type, param1, param2, param3, offset)
...
airports = string(fieldnames(runways_data));
...
for i=1:nAirports
    % Camera poses
    airport = airports(i);
    airport_data = runways_data.(airport);
    airport_origin = airport_data.origin;
